...
DDEESSCCRRIIPPTTIIOONN
       ...
       ceeds _i_s allowed to change _e_r_r_n_o.

       Valid error numbers are all nonzero; _e_r_r_n_o is never set to zero by  any
       system call or library function.

       For  some system calls and library functions (e.g., ggeettpprriioorriittyy(2)), -1
       is a valid return on success.  In such cases, a successful  return  can
       be  distinguished  from an error return by setting _e_r_r_n_o to zero before
       the call, and then, if the call returns a status that indicates that an
       error may have occurred, checking to see if _e_r_r_n_o has a nonzero value.
       ...
       with the exception of EEAAGGAAIINN and EEWWOOUULLDDBBLLOOCCKK, which may be the same.
       ...
       EEAADDDDRRIINNUUSSEE      Address already in use (POSIX.1)

       EEAADDDDRRNNOOTTAAVVAAIILL   Address not available (POSIX.1)

       EEAAFFNNOOSSUUPPPPOORRTT    Address family not supported (POSIX.1)

       EEAAGGAAIINN          Resource temporarily unavailable (may be the same value
                       as EEWWOOUULLDDBBLLOOCCKK) (POSIX.1)

       EEAALLRREEAADDYY        Connection already in progress (POSIX.1)
       ...
       EEBBAADDMMSSGG         Bad message (POSIX.1)
       ...
       EECCAANNCCEELLEEDD       Operation canceled (POSIX.1)
       ...
       EECCOONNNNAABBOORRTTEEDD    Connection aborted (POSIX.1)

       EECCOONNNNRREEFFUUSSEEDD    Connection refused (POSIX.1)

       EECCOONNNNRREESSEETT      Connection reset (POSIX.1)

       EEDDEEAADDLLKK         Resource deadlock avoided (POSIX.1)

       EEDDEEAADDLLOOCCKK       Synonym for EEDDEEAADDLLKK

       EEDDEESSTTAADDDDRRRREEQQ    Destination address required (POSIX.1)

       EEDDOOMM            Mathematics  argument  out  of   domain   of   function
                       (POSIX.1, C99)
       ...
       EEHHOOSSTTUUNNRREEAACCHH    Host is unreachable (POSIX.1)

       EEIIDDRRMM           Identifier removed (POSIX.1)

       EEIILLSSEEQQ          Illegal byte sequence (POSIX.1, C99)

       EEIINNPPRROOGGRREESSSS     Operation in progress (POSIX.1)

       EEIINNTTRR           Interrupted function call (POSIX.1); see ssiiggnnaall(7).

       EEIINNVVAALL          Invalid argument (POSIX.1)

       EEIIOO             Input/output error (POSIX.1)

       EEIISSCCOONNNN         Socket is connected (POSIX.1)
       ...
       EELLIIBBMMAAXX         Attempting to link in too many shared libraries
       ...
       EEMMFFIILLEE          Too  many  open  files  (POSIX.1);  commonly  caused by
                       exceeding the RRLLIIMMIITT__NNOOFFIILLEE resource limit described in
                       ggeettrrlliimmiitt(2)

       EEMMLLIINNKK          Too many links (POSIX.1)

       EEMMSSGGSSIIZZEE        Message too long (POSIX.1)

       EEMMUULLTTIIHHOOPP       Multihop attempted (POSIX.1)

       EENNAAMMEETTOOOOLLOONNGG    Filename too long (POSIX.1)

       EENNEETTDDOOWWNN        Network is down (POSIX.1)

       EENNEETTRREESSEETT       Connection aborted by network (POSIX.1)

       EENNEETTUUNNRREEAACCHH     Network unreachable (POSIX.1)

       EENNFFIILLEE          Too many open files in system (POSIX.1); on Linux, this
                       is   probably   a   result    of    encountering    the
                       _/_p_r_o_c_/_s_y_s_/_f_s_/_f_i_l_e_-_m_a_x limit (see pprroocc(5)).

       EENNOOBBUUFFSS         No   buffer   space  available  (POSIX.1  (XSI  STREAMS
                       option))

       EENNOODDAATTAA         No message is available on the STREAM head  read  queue
                       (POSIX.1)
       ...
       EENNOOEEXXEECC         Exec format error (POSIX.1)

       EENNOOKKEEYY          Required key not available

       EENNOOLLCCKK          No locks available (POSIX.1)

       EENNOOLLIINNKK         Link has been severed (POSIX.1)
       ...
       EENNOOPPRROOTTOOOOPPTT     Protocol not available (POSIX.1)
       ...
       EENNOOTTCCOONNNN        The socket is not connected (POSIX.1)

       EENNOOTTDDIIRR         Not a directory (POSIX.1)

       EENNOOTTEEMMPPTTYY       Directory not empty (POSIX.1)

       EENNOOTTSSOOCCKK        Not a socket (POSIX.1)

       EENNOOTTSSUUPP         Operation not supported (POSIX.1)
       ...
       EEOOPPNNOOTTSSUUPPPP      Operation not supported on socket (POSIX.1)

                       (EENNOOTTSSUUPP  and  EEOOPPNNOOTTSSUUPPPP have the same value on Linux,
                       but according to POSIX.1 these error values  should  be
                       distinct.)

       EEOOVVEERRFFLLOOWW       Value too large to be stored in data type (POSIX.1)
       ...
       EEPPRROOTTOONNOOSSUUPPPPOORRTT Protocol not supported (POSIX.1)

       EEPPRROOTTOOTTYYPPEE      Protocol wrong type for socket (POSIX.1)
       ...
       EERROOFFSS           Read-only filesystem (POSIX.1)

       EESSHHUUTTDDOOWWNN       Cannot send after transport endpoint shutdown
       ...
       EETTIIMMEEDDOOUUTT       Connection timed out (POSIX.1)

       EETTXXTTBBSSYY         Text file busy (POSIX.1)
       ...
       EEWWOOUULLDDBBLLOOCCKK     Operation  would  block  (may  be same value as EEAAGGAAIINN)
                       (POSIX.1)
